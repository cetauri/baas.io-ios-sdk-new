...
+ (BaasioQuery *)createWithEntityName:(NSString *)entityName;

//- (BaasioQuery *)queryWithEntityID:(NSString *)entityID;
//- (BaasioQuery *)query:(NSString *)query;
...
@end
//sortQuery, filterQuery, extraQuery